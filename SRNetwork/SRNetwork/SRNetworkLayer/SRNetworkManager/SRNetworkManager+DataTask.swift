...
extension SRNetworkManager{
	...
	public func serviceDataTaskManagerWith(httpMethodType : HTTPMethod = .get, url : String, headers : HTTPHeaders? = nil, encoding : ParameterEncoding = .url, urlParameter : HTTPParameter? = nil, networkJobType : NetworkTaskType = .dataTask, completionHandler : @escaping CompletionBlock) -> Void{
